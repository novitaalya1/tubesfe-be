<?php
    ...
    $url = "https://y9d9l5wr.directus.app/items/biodata?fields=id,nama,tgl_lahir,tinggi,berat,kota.nama,agama.nama";
    $curl = curl_init();
    ...
    for ($x = 0; $x < 25; $x++){
        ...
        echo "<td class='u-border-1 u-border-grey-40 u-border-no-left u-border-no-right u-table-cell'>".$hasil['data'][$x]['id']."</td>";
